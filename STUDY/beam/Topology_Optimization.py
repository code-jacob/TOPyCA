...
minimize = "ENERGY"           # "pseudo/shear deformation energy density" calculated simply as equivalent stress*strain
...
volume_tol_min = 0.08            # 0.1 = 10% tolerance for aim_volume_fraction
e_tol_vol = 0.1
Lambda = 1
